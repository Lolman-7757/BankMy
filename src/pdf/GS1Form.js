  ...
  return (
    <>
        ...
        <div className='pdf_container'>
            ...
            <div className='text_degree pdf_main_container'>
                ...
                <ul className='pdf_margin_top_30'>
                    <li className='number_list p1_left_space'>
                    ...
                    <li className='pdf_margin_top_10 number_list p1_left_space'>
                    ...
                    <li className='pdf_margin_top_20 number_list p1_left_space'>
