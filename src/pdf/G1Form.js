  ...
  return (
    <>
        ...
        <div className='pdf_container'>
            ...
            <p className='pdf_g1_preview_text pdf_margin_top_20'>
                Qarz to‘lovlarini qoplash
            </p>
            <p className='pdf_g1_preview_text'>
                JADVALI
            </p>
            <p className='pdf_g1_preview_text pdf_margin_top_10'>
                Usmonova Muyassar Abduvaliyevna
            </p>
            <div className='pdf_g1_table_first'>
                <div>
